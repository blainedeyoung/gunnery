...
package body ada_main is
   ...
   E150 : Short_Integer; pragma Import (Ada, E150, "points_E");
   E138 : Short_Integer; pragma Import (Ada, E138, "distanceandbearing_E");
   E164 : Short_Integer; pragma Import (Ada, E164, "units_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "distanceandbearing__finalize_spec");
      begin
         F1;
      end;
      E150 := E150 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "points__finalize_spec");
      begin
         F2;
      end;
      E094 := E094 - 1;
   ...
   begin
      ...
      Points'Elab_Body;
      E150 := E150 + 1;
      Distanceandbearing'Elab_Spec;
      Distanceandbearing'Elab_Body;
      E138 := E138 + 1;
      E164 := E164 + 1;
   end adainit;
...
--  BEGIN Object file/option list
   --   C:\GNAT\2021\bin\gunnery\obj\points.o
   --   C:\GNAT\2021\bin\gunnery\obj\DistanceAndBearing.o
   --   C:\GNAT\2021\bin\gunnery\obj\units.o
   --   C:\GNAT\2021\bin\gunnery\obj\main.o
   --   -LC:\GNAT\2021\bin\gunnery\obj\
   --   -LC:\GNAT\2021\bin\gunnery\obj\

...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#1beb890f#;
   ...
   u00137 : constant Version_32 := 16#927c4ffa#;
   pragma Export (C, u00137, "distanceandbearingB");
   u00138 : constant Version_32 := 16#7e55da70#;
   pragma Export (C, u00138, "distanceandbearingS");
   ...
   u00149 : constant Version_32 := 16#e1b9abf7#;
   pragma Export (C, u00149, "pointsB");
   u00150 : constant Version_32 := 16#97144f09#;
   pragma Export (C, u00150, "pointsS");
   ...
   u00154 : constant Version_32 := 16#248a0db1#;
   ...
   u00161 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00161, "system__fat_lfltS");
   u00162 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00162, "system__fat_llfS");
   u00163 : constant Version_32 := 16#f54e331e#;
   pragma Export (C, u00163, "unitsB");
   u00164 : constant Version_32 := 16#1c7ff74a#;
   pragma Export (C, u00164, "unitsS");
   ...
   --  points%s
   --  points%b
   --  distanceandbearing%s
   --  distanceandbearing%b
   --  units%s
   --  units%b
   --  main%b
